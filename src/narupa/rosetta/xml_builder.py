...
class RosettaScriptsBuilder:
  ...
  def update_renderer( self,
    ...
    active_particles = map( int, active_particles )
    if update_global:
  ...
  def add_task_operation( self,
                          ...
                          prevent_design : bool = False ) -> ( str, xml.Element ): # TODO implement a way to add multiple task_operations of different types.
    res_sele_names = []
